...
userCollectionUrl   =  base_url          + "/resource-service/resource/collect"
userCancelCollectionUrl = base_url       + "/resource-service/resource/cancelCollect"
userListCollectionUrl   = base_url       + "/member/collection/queryPage?currentPage=1&pageSize=10"
userResourceVisistUrl   = base_url       + "/resource-service/resource/visit"
...
delOperpositionurl   =    base_url    +  "/operation-manage/featured/removeIndexConfig"
